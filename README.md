...
**Inets-isomorphism** - реализация поиска точного графового изоморфизма. Реализует алгоритм структурного сопоставления графов с отсечением неперспективных ветвей (бэктрекинг), аналогичный подходу VF2.
